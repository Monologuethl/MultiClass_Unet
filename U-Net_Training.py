...
from keras.layers import Input, Conv2D, MaxPooling2D, UpSampling2D, Reshape, Activation, Permute, concatenate
...
hist = model.fit(x=train_x, y=train_y, batch_size=batch_size, epochs=epochs, verbose=1, shuffle=True,
